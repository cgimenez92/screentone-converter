...
def crear_patron(tipo, tamaño=12):  # Increased from 6 to 12 for better precision
    ...
    if tipo == 'rayas_horizontales':
        ...
        for i in range(0, tamaño, 2):
            draw.line((i, 0, i, tamaño), fill=0, width=1)
        ...
        for x in range(1, tamaño, 3):
            for y in range(1, tamaño, 3):
        ...
        for i in range(0, tamaño, 2):
            draw.line((i, 0, i+1, tamaño), fill=0, width=1)
            draw.line((i+1, 0, i, tamaño), fill=0, width=1)
    elif tipo == 'ondas':
        for i in range(0, tamaño, 2):
            draw.line((i, int(tamaño/2), i+2, int(tamaño/2)-2), fill=0, width=1)
            draw.line((i+2, int(tamaño/2)-2, i+4, int(tamaño/2)), fill=0, width=1)
